...
class StrategyInterface {
  ...
  /**
   * Must return the property used as "default".
   *
   * @param {string} defaultValue The default value to use
   * @returns {object|null} Null to omit property from the result
   */
  getPropertyDefault(defaultValue) {
    this.constructor._throwMissingImplementationError(this.constructor.name, 'getPropertyDefault');
  }
