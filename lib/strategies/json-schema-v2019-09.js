...
class JsonSchema201909Strategy extends StrategyInterface {
  ...
  /**
   * Returns null because 2019-09 no longer uses the "$id" field for base URI changes.
   *
   * @see {@link https://json-schema.org/draft/2020-12/release-notes.html#embedded-schemas-and-bundling}
   * @example null
   * @param {string} path
   * @returns {null}
   */
