...
/**
 * Strategy responsible for converting Sequelize models into `JSON Schema v6` schema.
 *
 * @class SchemaManager
 */
class JsonSchema6Strategy extends StrategyInterface {
   ...
   * @returns {object}
   */
  static getObjectPropertyId(baseUri, propertyName) {
    return {
   ...
   * @returns {object}
   */
  static getObjectPropertySchema() {
    return {
