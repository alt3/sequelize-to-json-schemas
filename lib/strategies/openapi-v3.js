...
/**
 * Strategy responsible for converting Sequelize models into `OpenAPI v6` schema.
 *
 * @class SchemaManager
 */
class OpenApi3Strategy extends StrategyInterface {
   ...
   */
  // prettier-ignore
  static getObjectPropertyId(baseUri, propertyName) { // eslint-disable-line no-unused-vars
    return null;
  }
   ...
   */
  // prettier-ignore
  static getObjectPropertySchema() { // eslint-disable-line no-unused-vars
    return null;
  }
}
