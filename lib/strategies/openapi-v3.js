...
class OpenApi3Strategy extends StrategyInterface {
  ...
  /**
   * Returns null because OpenAPI 3 does not support the "id" field for a schema.
   *
   * @example null
   * @param {string} path
   * @returns {null}
  ...
  /**
   * Returns null because OpenAPI 3.0 does not support the "id" field for a property.
   *
   * @example null
   * @param {string} path
   * @returns {null}
